...
declare global {
  ...
  const effectScope: typeof import('vue')['effectScope']
  const env: typeof import('./src/utils/configs')['env']
  ...
  const useBody: typeof import('./src/composables/useBody')['useBody']
  ...
  const useQueryParams: typeof import('./src/composables/useQueryParams')['useQueryParams']
